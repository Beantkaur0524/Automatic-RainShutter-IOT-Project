...
//experimenatl
char userName[] = "AgUcDSAINS0YCxcnExsRFBI"; // added device userId
char passKey[] = "j2OGsP+eI/RKFoxmwLfiS1vh"; // added device pasword
char clientId[] = "AgUcDSAINS0YCxcnExsRFBI"; // added device clientId
...
//      Serial.println(clientId);
  ...
  String data = "field1=" + String(temperature) + "&field2=" + String(humidity)+ "&field3=" + String(pressure)+ "&field4=" + String(rainfall) + "&status=MQTTPUBLISH";
